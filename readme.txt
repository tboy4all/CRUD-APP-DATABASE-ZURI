1.	Extract the CRUD folder
2.	run npm install on the CRUD folder to install all the node modules and dependecies
3.	download postman to test all the endpoints
		URLS
